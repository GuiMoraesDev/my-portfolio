export const ArticlesSkeleton = () => (
  <div className="flex w-full flex-col items-start justify-start gap-4">
    <div className="bg-plum-500/90 flex h-24 w-full flex-col items-start justify-center gap-4 rounded-md px-5 md:h-14 md:flex-row md:items-center md:justify-between xl:gap-5">
