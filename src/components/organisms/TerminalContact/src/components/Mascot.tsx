      ...
      <AnimatePresence mode="wait">
        {currentMessage && (
          <motion.div
            ...
            className="absolute bottom-full mb-1 rounded-lg border border-plum-300/40 bg-plum-900 px-3 py-1.5 text-xs font-medium whitespace-nowrap text-plum-100 shadow-md"
          >
            {currentMessage}
            <span className="absolute top-full left-1/2 -translate-x-1/2 border-x-4 border-t-4 border-x-transparent border-t-plum-900" />
          </motion.div>
        )}
      </AnimatePresence>
