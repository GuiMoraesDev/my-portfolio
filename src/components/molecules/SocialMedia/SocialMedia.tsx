  ...
  return (
    ...
    >
      <Link
        ...
        className="motion-hover-lift order-2 flex cursor-pointer flex-col items-center justify-center gap-2 rounded-md md:order-1"
      >
      ...
      <button
        ...
        className="motion-hover-lift group order-1 flex w-full min-w-40 cursor-pointer items-center justify-center gap-2 rounded-md bg-plum-500/90 p-4 shadow-sm transition-colors duration-200 hover:bg-plum-500 md:w-auto"
      >
