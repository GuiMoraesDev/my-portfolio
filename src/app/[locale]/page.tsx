    ...
    <main className="relative container flex w-full flex-col items-center">
      ...
      <SessionWrapper id="home">
        <header className="flex w-full flex-col items-center justify-between gap-6 md:flex-row">
          <h1
            id="my-title"
            className="inline-flex flex-col font-title text-2xl font-bold text-plum-light md:text-3xl lg:text-4xl dark:text-gold-light"
          >
            {t("home.hello")}
          </h1>
      ...
      <footer
        id="footer"
        className="flex flex-col gap-4 p-16 text-center text-sm dark:text-gold-light"
      >
        <span>
