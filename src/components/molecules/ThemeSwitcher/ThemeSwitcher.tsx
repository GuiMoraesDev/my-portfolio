...
const BulbIcon = () => (
  ...
  >
    <path
      ...
      className="stroke-black transition-colors duration-500 dark:stroke-gold-light"
      strokeWidth="2"
      strokeLinecap="round"
    ...
    <circle
      ...
      cy="10"
      r="3"
      className="fill-black transition-colors duration-500 dark:fill-gold-lighter"
    />
