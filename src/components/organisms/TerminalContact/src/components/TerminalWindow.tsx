...
export const TerminalWindow = () => {
  ...
  return (
    <motion.div
      ...
      dragElastic={0}
      dragMomentum={false}
      className="z-100 flex h-[min(30rem,85dvh)] w-[95dvw] max-w-2xl flex-col overflow-hidden rounded border border-border-strong bg-terminal-surface shadow-[0_16px_48px_rgba(0,0,0,0.7)]"
    >
      <DialogTitle>
        <header
