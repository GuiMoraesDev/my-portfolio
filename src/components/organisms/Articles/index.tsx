      ...
      {articles.map(
        ({
          ...
          <a
            ...
            className="group flex h-24 w-full flex-col items-start justify-center gap-4 rounded-md bg-plum-500/95 px-5 md:h-14 md:flex-row md:items-center md:justify-between xl:gap-5"
          >
...
const ArticlesSkeleton = () => (
  <div className="flex w-full flex-col items-start justify-start gap-4">
    <div className="flex h-24 w-full flex-col items-start justify-center gap-4 rounded-md bg-plum-500/95 px-5 md:h-14 md:flex-row md:items-center md:justify-between xl:gap-5">
      <div className="flex w-full items-center justify-start gap-2">
        <div className="h-4 w-4 animate-pulse rounded-md bg-white/80" />
        <div className="h-4 w-1/2 animate-pulse rounded-md bg-white/80" />
      </div>
